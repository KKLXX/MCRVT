...
from utils import create_PositionalEncoding, add_position, _get_activation_fn
from VA_layer import VA_Encoder
...
class VA(nn.Module):
    def __init__(self, 
        ...
        self.layers = nn.ModuleList(
            [VA_Encoder(input_dim, ffn_embed_dim, num_heads, length, duration_init_min, duration_init_max, dropout, bias, activation)
